...
@Component({
  ...
  styles: [`
    ...
    .sub{margin-left:30px!important;padding:8px 12px!important;width:calc(100% - 30px);font-size:13px;color:#aeb7c6!important}.sub.active{color:#fff!important;background:#2b3039}
