                  ...
                  @for (pkg of f.packagesFor(shipment.id); track pkg.id) {
                    <div class="package-card">
                      ...
                      <div class="package-fields">
                        ...
                        <div class="contents-summary"><b>Assigned products:</b> {{ contentsSummary(pkg) }}</div>
                      </div>
...
export class FulfilmentComponent implements OnInit {
  ...
  contentsSummary(pkg:ShipmentPackageRow){const names=[...new Set(this.f.packageContents(pkg).map(x=>x.product_name))];return names.length?names.join(' · '):'not specified';}
