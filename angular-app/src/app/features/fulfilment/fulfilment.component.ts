...
import { FastCourierQuote, FastCourierQuoteRequest } from '../../core/services/fast-courier.service';
                  ...
                  @if (f.quotesFor(shipment).length) {
                    <div class="quote-list">
                      @for (quote of f.quotesFor(shipment); track quote.id) {
                        <button type="button" class="quote-card" [class.selected]="shipment.selected_quote_id === quote.id" (click)="f.selectFastCourierQuote(shipment,quote)">
                          ...
                          <div class="quote-price"><b>{{ money(quote.priceIncludingGst) }}</b><span>incl. GST</span></div>
