...
@Component({selector:'app-package-drawings',standalone:true,imports:[BoxDrawingComponent,BoxRdFilesComponent],template:`
 @if(backdrop){
  @if(sharedSize){<small>{{sizeLabel}}</small><app-box-drawing [sharedSize]="sharedSize" /><app-box-rd-files [signature]="signature" [index]="index" />}
 ...
 }@else{<app-box-drawing [signature]="signature" [index]="index" [box]="box" /><app-box-rd-files [signature]="signature" [index]="index" />}
