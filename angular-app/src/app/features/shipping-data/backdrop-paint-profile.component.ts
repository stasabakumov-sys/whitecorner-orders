...
<details class="paint" [open]="mode==='minutes'"><summary>{{mode==='materials'?'Paint materials':'Painting minutes'}} · shared by all sizes and constructions</summary>
 @if(mode==='materials'){
 <p>Enter paint materials once. The same quantities are used for Foldable and Non-foldable.</p>
 ...
 <p>Enter painting time once. Size and Foldable/Non-foldable do not change these minutes.</p>
