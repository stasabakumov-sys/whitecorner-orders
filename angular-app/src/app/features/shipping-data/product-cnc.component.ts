...
@Component({selector:'app-product-cnc',standalone:true,imports:[FormsModule],template:`
 ...
 .icon-control{display:inline-grid;place-items:center;flex:none;width:28px;height:28px;padding:0;border:1px solid var(--wc-border);border-radius:6px;background:var(--wc-surface);color:inherit;cursor:pointer}.icon-control svg{display:block;width:16px;height:16px;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;stroke-linejoin:round}.icon-control:hover,.upload:hover{background:var(--wc-ground)}.icon-control:disabled{opacity:.5;cursor:default}.replace-icon{position:relative;overflow:hidden}.replace-icon:has(input:disabled){opacity:.5;cursor:default}
