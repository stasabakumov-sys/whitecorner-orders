...
@Component({
  ...
  template: `
          ...
          <tr>
            <td colspan="6">
              <div class="empty">
                ...
                <small>Inbox / Needs reply / Sent stay as working views; AI will populate the analysis behind each thread.</small>
              </div>
            </td>
          </tr>
        </ng-template>
    ...
    <p-drawer
      ...
      styleClass="mail-drawer"
    >
      @if(selected(); as mail){
        <ng-template pTemplate="header">
          <div class="drawer-title">
            <b>{{ mail.subject }}</b>
            <span>{{ mail.correspondent }}</span>
          </div>
        </ng-template>
        ...
        <div class="drawerbody">
          <section>
            ...
            <div class="message-card">
              <div class="message-meta"><b>{{ mail.direction }}</b><span>{{ mail.received_at }}</span></div>
              <p>{{ mail.preview || 'Message content will appear here when the mailbox is connected.' }}</p>
            </div>
          </section>
          ...
          <section>
            ...
            <div class="analysis-grid">
              ...
              <div><small>Intent</small><b>{{ mail.intent || 'Not analysed' }}</b></div>
            ...
            <div class="recommendation">
              ...
              <p>{{ mail.recommended_action || 'AI recommendation will appear here after analysis.' }}</p>
            </div>
          ...
          <section>
            ...
            <div class="draft-actions">
              <p-button label="Regenerate" icon="pi pi-refresh" [outlined]="true" [disabled]="true" />
              <p-button label="Send" icon="pi pi-send" [disabled]="true" />
            </div>
