      ...
      <p-table [value]="filtered()" [rowHover]="true" [tableStyle]="{'min-width':'900px'}">
        ...
        <ng-template pTemplate="body" let-order>
          <tr class="row" (click)="selected.set(order)">
            ...
            <td><span class="method" [class.pickup]="isPickup(order)"><i [class]="isPickup(order)?'pi pi-map-marker':'pi pi-truck'"></i>{{isPickup(order)?'Pickup':'Delivery'}}</span></td>
