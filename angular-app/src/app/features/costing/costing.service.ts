...
export class CostingService {
 ...
 async saveBackdropMaterialProfile(part:any,lines:any[],confirmed:boolean,expected:string|null){return this.write('wc_save_backdrop_material_profile',{p_product:part.shipping_product_id,p_size:part.size_key||part.options?.Size,p_folding:part.folding,p_lines:lines.map(l=>({material_id:l.material_id,quantity:Number(l.quantity)})),p_confirmed:confirmed,p_expected:expected});}
