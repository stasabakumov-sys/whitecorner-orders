-- Keep existing .tap attachments readable; new and replacement CNC files use .crc3d.
...
begin
 ...
 if p_filename is null or p_filename !~* '\.crc3d$' or length(p_filename)>255 or p_size is null or p_size<1 or p_size>20971520
 ...
 then raise exception 'Invalid or missing CRC3D file'; end if;
