-- Short notes for future Pans status changes; existing activity remains unchanged.
...
begin
 ...
 values((source->>'order_id')::uuid,p_item_id,'note',
  case when p_status='ordered_and_sent' then 'Pans were sent.' else 'Pans dispatch mark was removed.' end,actor::text)
