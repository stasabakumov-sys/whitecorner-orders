-- Cart material profiles belong to the product and size, so operators can
-- configure them before the first matching Wix order exists.

create function public.wc_save_cart_material_profile(
 p_product uuid,
 p_size text,
 p_kind text,
 p_lines jsonb,
...
begin
 ...
 select product_name into v_product_name from wc_shipping_products where id=p_product and active and product_type='Cart';
