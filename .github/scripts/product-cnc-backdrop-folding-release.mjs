...
if(process.argv.includes('--verify')){console.log('Read-only Backdrop CNC state:',before.already_registered?JSON.stringify((await query(verify,true))[0]):'Migration pending; schema postflight will run after apply.');process.exit(0);}
